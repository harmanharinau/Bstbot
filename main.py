...
async def start_handler(_, event: Message):
	await event.reply_photo("https://telegra.ph/file/c9b51440351ec5718017d.jpg",
...
async def inline_handlers(_, event: Message):
    ...
    async for message in User.search_messages(chat_id=Config.CHANNEL_ID, limit=1000, query=event.text):
        if message.text:
            thumb = None
            f_text = message.text
            ...
            answers += f'**📜➠ ' + '' + f_text.split("\n", 2)[-1] + ' \n\n▰▱▰▱▰▱▰▱▰▱▰▱▰▱\nMessage Will Auto Delete In After Some Time...⏰\n▰▱▰▱▰▱▰▱▰▱▰▱▰▱\n\n**'
    try:
